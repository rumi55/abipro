<div class="row">
    ...
    <div class="col-md-12">
      <div class="form-group">
        <div class="mt-2">
          <div class="icheck-success d-inline">
            <input type="radio" name="layout" value="detail" id="detail"  {{request('layout')=='detail' || empty(request('layout'))?'checked':''}} >
            <label for="detail">
              Detail
            </label>
          </div>
          <div class="icheck-success d-inline">
            <input type="radio" name="layout" value="summary" id="summary" {{request('layout')=='summary'?'checked':''}} >
            <label for="summary">
              Ringkas
            </label>
          </div>
