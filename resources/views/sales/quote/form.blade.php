                ...
                <div class="col-md-8 col-sm-12 text-right">
                    <div class="form-group row">
                        ...
                        <div class="col-md-4 col-sm-10">
                            <input name="transaction[subtotal]" tabindex="-1" type="text" class="subtotal form-control-plaintext text-success number text-bold" readonly id="subtotal" value="{{fcurrency(old('transaction.subtotal', empty($transaction->subtotal)?'0':$transaction->subtotal))}}" data-inputmask="'alias':'decimal', 'groupSeparator': '.', 'radixPoint':',', 'autoGroup': true, 'digits': 2, 'digitsOptional': false, 'prefix': ''" data-mask/>
                    ...
                    <div id="tax-container" class="form-group row">
                        ...
                        <div class="col-md-4 col-sm-10">
                            <input name="transaction[tax]" tabindex="-1" type="text" class="tax number form-control-plaintext text-success text-bold" readonly id="tax" value="{{fcurrency(old('transaction.tax', empty($transaction->tax)?'0':$transaction->tax))}}" data-inputmask="'alias':'decimal', 'groupSeparator': '.', 'radixPoint':',', 'autoGroup': true, 'digits': 2, 'digitsOptional': false, 'prefix': ''" data-mask/>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-4 col-sm-10">
                            <input name="transaction[total]" tabindex="-1" type="text" class="total number form-control-plaintext text-success text-bold" readonly id="total" value="{{fcurrency(old('transaction.total', empty($transaction->total)?'0':$transaction->total))}}" data-inputmask="'alias':'decimal', 'groupSeparator': '.', 'radixPoint':',', 'autoGroup': true, 'digits': 2, 'digitsOptional': false, 'prefix': ''" data-mask/>
